...
public class GuangzhouMaternityAllowanceStrategy implements MaternityAllowanceStrategy {
    ...
    public MaternityAllowanceResponse calculateMaternityAllowance(MaternityAllowanceRequest request) {
        ...
        // 2. 计算产假应付工资
        BigDecimal paidMaternityWage = maternityWageCalculatorService.calculateMaternityWage(
        ...
        response.setCityName(CityEnum.GUANGZHOU.getChineseName());
    ...
    public String getSupportedCityCode() {
        return  CityEnum.GUANGZHOU.getCode();
    }
}
