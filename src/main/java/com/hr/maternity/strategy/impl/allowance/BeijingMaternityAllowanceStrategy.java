...
public class BeijingMaternityAllowanceStrategy implements MaternityAllowanceStrategy {
    ...
    public MaternityAllowanceResponse calculateMaternityAllowance(MaternityAllowanceRequest request) {
        ...
        // 计算补差金额（员工应享受补贴 - 产假期间发放工资）
        compensationAmount = entitledSubsidy.subtract(paidMaternityWage);
    ...
    public String getSupportedCityCode() {
        return CityEnum.BEIJING.getCode();
    }
}
