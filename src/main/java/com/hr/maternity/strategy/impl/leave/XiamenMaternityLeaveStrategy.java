package com.hr.maternity.strategy.impl.leave;
...
import com.hr.maternity.enums.LeaveArgsOfCityEnum;
...
@Component
public class XiamenMaternityLeaveStrategy extends BaseMaternityLeave implements MaternityLeaveStrategy {
    ...
    public MaternityLeaveResponse calculateMaternityLeave(MaternityLeaveRequest request) {
        ...
        int extendedDays = shArgs.getExtendedDays();// 80
        ...
        // 未流产：休法定产假+难产假+多胞胎假+晚育假｜生育假｜奖励假
            ...
            if (request.getNumberOfBabies() > 1) {
                ...
                if (totalDays > 180) {
                    multiBabyDays = multiBabyDays - (totalDays - 180);
                    totalDays = 180;
                }
                timeScopeList.add(TimeScope.builder()
                        .index(3)
            ...
            if (request.getHasExtendedDays()) {
                ...
                if (totalDays > 180) {
                    extendedDays = extendedDays - (totalDays - 180);
                    totalDays = 180;
                }
                timeScopeList.add(TimeScope.builder()
                        .index(4)
        ...
        // 【厦门生育津贴不包含奖励假】
        int totalAllowanceDays = totalDays - extendedDays;
