...
public class SuzhouMaternityAllowanceStrategy implements MaternityAllowanceStrategy {
    ...
    public MaternityAllowanceResponse calculateMaternityAllowance(MaternityAllowanceRequest request) {
        ...
        response.setCityName(CityEnum.SUZHOU.getChineseName());
    ...
    public String getSupportedCityCode() {
        return  CityEnum.SUZHOU.getCode();
    }
}
